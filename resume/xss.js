...
function stripBlankChar (html) {
  ...
  chars = chars.filter(function (char) {
    ...
    if (c <= 10="" 31)="" {="" if="" (c="==" ||="" c="==" 13)="" return="" true;="" false;="" }="" });="" chars.join('');="" exports.whitelist="whiteList;" exports.ontag="onTag;" exports.onignoretag="onIgnoreTag;" exports.ontagattr="onTagAttr;" exports.onignoretagattr="onIgnoreTagAttr;" exports.safeattrvalue="safeAttrValue;" exports.escapehtml="escapeHtml;" exports.escapequote="escapeQuote;" exports.unescapequote="unescapeQuote;" exports.escapehtmlentities="escapeHtmlEntities;" exports.escapedangerhtml5entities="escapeDangerHtml5Entities;" exports.clearnonprintablecharacter="clearNonPrintableCharacter;" exports.friendlyattrvalue="friendlyAttrValue;" exports.escapeattrvalue="escapeAttrValue;" exports.onignoretagstripall="onIgnoreTagStripAll;" exports.striptagbody="StripTagBody;" exports.stripcommenttag="stripCommentTag;" exports.stripblankchar="stripBlankChar;" },{}],2:[function(require,module,exports){="" **="" *="" 模块入口="" @author="" 老雷<leizongmin@gmail.com="">
 */
...
FilterXSS.prototype.process = function (html) {
  ...
  var retHtml = parseTag(html, function (sourcePosition, position, tag, html, isClosing) {
    ...
    if (info.isWhite) {
      ...
      // 构造新的标签代码
      var html = '</leizongmin@gmail.com></a></a></a></leizongmin@gmail.com></=></r.length;o++)s(r[o]);return>